...
| [09-对标Hermes与规划修订](./09-对标Hermes与规划修订.md) | 对标 Hermes Agent、缺口分析与 **规划修订（权威）** |
...
> Phase 排期以 [09-对标Hermes与规划修订](./09-对标Hermes与规划修订.md) 为准。

| Phase | 名称 | 状态 |
|-------|------|------|
| 1 | 平台底座 | ✅ 已完成 |
| 1.5 | 收尾门禁 | ⬜ Alembic / Auth / 集成测试 |
| 2 | Soul + Context + Tool Registry | ⬜ 待开发 |
| 3 | Model Hub + Cancel/Queue | ⬜ 待开发 |
| 4 | Workdir + ToolGuard | ⬜ 待开发 |
| 5 | Skills 工场 | ⬜ 待开发 |
| 6 | 编排 + delegate | ⬜ 待开发 |
| 7 | HITL 完整 UI | ⬜ 待开发 |
| 8 | 监控 + 会话检索 + Scheduler | ⬜ 部分（LangSmith） |
| 9 | IntentGate + Cron 投递 | ⬜ 待开发 |
...
| 版本 | 日期 | 说明 |
|------|------|------|
| 0.2.0 | 2026-05-20 | Hermes 对标、规划修订（Phase 1.5–9 重排） |
